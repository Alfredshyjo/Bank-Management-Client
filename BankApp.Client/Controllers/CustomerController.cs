    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> CreateAccount()
        {
            try
            {
                ...
                {
                    new AccountTypeDto { AccountTypeId = 1, Name = "Savings Account" },
                    new AccountTypeDto { AccountTypeId = 2, Name = "Current Account" },
                    new AccountTypeDto { AccountTypeId = 3, Name = "Fixed Deposit Account" }
                };
        ...
        public async Task<IActionResult> CreateAccount(CreateAccountViewModel model)
        {
            ...
            try
            {
                var accountDto = new AccountDto
                {
                    ...
                    Status = "Active", // String value, not int
                    AccountNumber = "", // Will be generated by API
